...
urlpatterns = patterns('',
    ...
    url(r'^CrearSalidas/$',CrearSalidas),
    url(r'^outProduct/$',outProduct),
    url(r'^ReportesSalidas/$',ReportesSalidas),
    url(r'^InprimirIngresoProductos/(?P<id>\d+)/(?P<inicio>[^/]+)/(?P<final>[^/]+)/$',InprimirIngresoProductos),
    url(r'^InprimirSalidaProductos/(?P<id>\d+)/(?P<inicio>[^/]+)/(?P<final>[^/]+)/$',InprimirSalidaProductos),
    ...
    url(r'^registroSalidas/$',registroSalidas),
    url(r'^VerSalidas/$',VerSalidas),
    url(r'^editSalida/(?P<id>\d+)/$',editSalida),
    url(r'^deleteSalida/(?P<id>\d+)/$',deleteSalida),
    url(r'^Delete_salida/(?P<id>\d+)/$',Delete_salida),
    url(r'^RecuperarSalida/(?P<id>\d+)/$',RecuperarSalida),
    url(r'^recuperar_salida/(?P<id>\d+)/$',recuperar_salida),
)
